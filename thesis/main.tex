...
Reported industry arrangements, not yet in force, would bring \ac{BNPL} inside that regime without evidence of their effect.
...
Cross-platform stacking emerges without being programmed, reaching 45\% of \ac{BNPL} holders at four platforms, yet population default does not rise with the number of platforms: the injection raises default by 1.2 percentage points without peer influence and 2.1 with it, however many firms the obligations are spread across.
Default rises smoothly with \ac{BNPL} access under both a linear and a heterogeneous-threshold adoption rule, with no tipping point under either, although the threshold rule roughly triples the rise in holding.
