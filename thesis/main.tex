...
% patterns, and the headline result for each research question. State the affordability-only
% scope of bureau visibility. Report the final nonlinearity test without assuming its outcome.
