...
The behavioural micro-foundations of Sections~\ref{sec:lit-bnpl} and~\ref{sec:lit-behavioural} are
drawn from United States evidence and applied to South African borrowers: the minimum-payer share of 0.29, the present-bias
...
The available anchors are indirect: the 82.8\% banked ceiling, TransUnion's report of 57\% of
consumers holding a \ac{BNPL} product by late 2025 \cite{transunion_cps_sa_2025}, and the
\ac{CFPB} stacking shares.
