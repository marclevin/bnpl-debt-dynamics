...
\ac{BNPL} is an intervention, and appears as the second scenario of Submodel~15.
...
\textbf{Uniform activation order (Submodel~17).} Random activation avoids a fixed household
sequence. There is no shared credit pool for early households to exhaust, and all households
read the same lagged peer signal. Alternative schedules test for remaining implementation
sensitivity, motivated by the findings of Comer and Loerch \cite{comer2013activation} and
Alizadeh and Cioffi-Revilla \cite{alizadeh2015activation}.
