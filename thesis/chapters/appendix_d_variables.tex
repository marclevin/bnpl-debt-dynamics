...
\small
\begin{longtable}{L{2.9cm}L{3.2cm}L{3.9cm}L{2.0cm}L{1.3cm}}
...
in Section~\ref{ch:population} and as the resampling probability in
...
the credit-granting gate of Submodel~9, so the data layer and the model apply one test.
