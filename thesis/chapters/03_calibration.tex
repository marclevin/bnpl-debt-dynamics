...
The fitted shock probability is more than three times the upper bound of the observed separation-rate range (0.54--1.17\% per tick).
...
The cumulative 60+ day share is closer, at 15.0\% against 16.5\%, but includes the fitted 90+ band and is therefore not an independent check.
...
\midrule
\emph{60+ days} & \emph{16.54} & \emph{15.01} & \emph{partly fitted} \\
\bottomrule
\end{tabular}
\end{table}
