...
Table~\ref{tab:further-caveats} records eight limitations that are real but do not bound the
...
so opening servicing is an upper bound. Repayment horizons are now sourced -- two measured in
\ac{NIDS}, three from \ac{CCMR} stock-flow implied life -- except revolving credit, which has no
...
& Overstates total outgoings for the 8.9\% of households reporting such a payment \\
\addlinespace
