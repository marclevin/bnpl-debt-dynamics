...
The baseline is calibrated, not validated & Two parameters are fitted to two \ac{CCMR} bands; agreement on those bands is not evidence, and the fitted shock rate is roughly four times the labour-force separation rate because one channel does the work of several & Section~\ref{sec:lim-calibration}; bounds every baseline agreement \\
\addlinespace
...
scenarios of Section~\ref{sec:results-rq3}, but by decision are reported only here: a
